...
public class PlayerController : MonoBehaviour
{
    ...
    public float cameraDistanceFromHead = 5;
    public float cameraSizeRadius = 0.5f;
    Ray cameraClipRay;
    RaycastHit terrainBehindPlayer;
    ...
    public void LookAngle(Vector2 cameraInput) // This variable is public so it can be altered by other sources such as gun recoil
    {
        ...
        {
            cd = terrainBehindPlayer.distance - cameraSizeRadius;
        }
        else
        {
    ...
    void LerpCrouch(float t)
    {
        ...
        float sm = Mathf.Lerp(1, crouchSpeedMultiplier, crouchTimer); // Lerps crouch speed multiplier between none and the normal amount
        speed = movementSpeed * sm; // Adds crouch speed multiplier to movement speed effects
